...
describe("Appointment Service", () => {
    ...
    describe("findAll", () => {
        it("should return a list of appointments", async () => {
            appoinmentsRepository_1.appointmentRepository.findAllAsync = jest
                .fn()
                .mockResolvedValue([mockAppointmentData]);
            const result = await appoinmentsService_1.appointmentService.findAll();
    ...
    describe("findById", () => {
        it("should return an appointment for a valid ID", async () => {
            const id = 1;
            appoinmentsRepository_1.appointmentRepository.findByIdAsync = jest
                .fn()
                .mockResolvedValue(mockAppointmentData);
            const result = await appoinmentsService_1.appointmentService.findById(id);
            expect(result.statusCode).toEqual(http_status_codes_1.StatusCodes.OK);
            expect(result.success).toBeTruthy();
    ...
    describe("create", () => {
        it("should create a new appointment", async () => {
            appoinmentsRepository_1.appointmentRepository.create = jest
                .fn()
                .mockResolvedValue(mockAppointmentData);
            const result = await appoinmentsService_1.appointmentService.create(mockAppointmentData);
    ...
    describe("update", () => {
        it("should update an existing appointment", async () => {
            const id = 1;
            appoinmentsRepository_1.appointmentRepository.update = jest
                .fn()
                .mockResolvedValue(mockAppointmentData);
            const result = await appoinmentsService_1.appointmentService.update(id, mockAppointmentData);
            expect(result.statusCode).toEqual(http_status_codes_1.StatusCodes.OK);
            expect(result.success).toBeTruthy();
    ...
    describe("delete", () => {
        it("should delete an existing appointment", async () => {
            const id = 1;
            appoinmentsRepository_1.appointmentRepository.delete = jest
                .fn()
                .mockResolvedValue(mockAppointmentData);
            const result = await appoinmentsService_1.appointmentService.delete(id);
            expect(result.statusCode).toEqual(http_status_codes_1.StatusCodes.OK);
            expect(result.success).toBeTruthy();
